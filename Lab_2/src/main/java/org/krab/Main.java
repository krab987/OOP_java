...
public class Main {
    public static void main(String[] args) {
        ...
        alcoList.add(new AlkoDrink("Aperol", "Jenna S", PackageDrink.glass, 100, new GregorianCalendar(2005, 3, 21), 60, 42));
        alcoList.add(new AlkoDrink("Jack Daniel`s", "NOJack", PackageDrink.glass, 200, new GregorianCalendar(2014, 2, 25), 120, 40));
        alcoList.add(new AlkoDrink("BeerMix", "Obolon", PackageDrink.glass, 10, new GregorianCalendar(2022, 11, 25), 12, 4));
    ...
    private static void equalCheckAlco(List<AlkoDrink> alcoList, int ind1, short in2) {
